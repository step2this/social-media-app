...
/**
 * State of a builder during execution
 */
export type BuilderState = 'idle' | 'validating' | 'building' | 'completed' | 'failed';

/**
 * Context passed through builder execution pipeline
 */
...
/**
 * Hook function that can be called at various builder lifecycle stages
 */
export type BuilderHook<T> = (data: T, context: BuildContext) => void | Promise<void>;
...
/**
 * Re-export commonly used utility types from TypeScript
 */
export type {
  Partial,
  Required,
