...
/**
 * Configuration for building a comment
 */
 ...
 * 
 * Uses CommentService.createComment() to ensure proper entity structure.
 * 
 * Note: Unlike LikeService, CommentService does NOT increment the post's
 * commentsCount directly. This is handled by DynamoDB streams in production.
 * For test data purposes, this means comment counts may not immediately reflect
 * in post entities (this is expected behavior matching production architecture).
 */
