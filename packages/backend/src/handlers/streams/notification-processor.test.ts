    ...
    it('should create "liked your post" notification when LIKE is inserted', async () => {
      const event = createMockDynamoDBStreamEvent({
        records: [
          {
            eventName: 'INSERT',
            keys: { PK: 'USER#liker-123', SK: 'LIKE#post-456' },
            newImage: {
              PK: 'USER#liker-123',
              SK: 'LIKE#post-456',
              entityType: 'LIKE',
    ...
    it('should extract correct actor information from LIKE entity', async () => {
      const event = createMockDynamoDBStreamEvent({
        records: [
          {
            eventName: 'INSERT',
            keys: { PK: 'USER#actor-123', SK: 'LIKE#post-456' },
            newImage: {
              PK: 'USER#actor-123',
              SK: 'LIKE#post-456',
              entityType: 'LIKE',
    ...
    it('should not notify when user likes their own post', async () => {
      const event = createMockDynamoDBStreamEvent({
        records: [
          {
            eventName: 'INSERT',
            keys: { PK: 'USER#user-123', SK: 'LIKE#post-456' },
            newImage: {
              PK: 'USER#user-123',
              SK: 'LIKE#post-456',
              entityType: 'LIKE',
    ...
    it('should create "commented on your post" notification when COMMENT is inserted', async () => {
      const event = createMockDynamoDBStreamEvent({
        records: [
          {
            eventName: 'INSERT',
            keys: { PK: 'POST#post-456', SK: 'COMMENT#2024-01-01T00:00:00.000Z#comment-123' },
            newImage: {
              PK: 'POST#post-456',
    ...
    it('should send notification to followee', async () => {
      const event = createMockDynamoDBStreamEvent({
        records: [
          {
            eventName: 'INSERT',
            keys: { PK: 'USER#follower-123', SK: 'FOLLOW#followee-999' },
            newImage: {
              PK: 'USER#follower-123',
    ...
    it('should not notify when user follows themselves', async () => {
      const event = createMockDynamoDBStreamEvent({
        records: [
          {
            eventName: 'INSERT',
            keys: { PK: 'USER#user-123', SK: 'FOLLOW#user-123' },
            newImage: {
              PK: 'USER#user-123',
              SK: 'FOLLOW#user-123',
    ...
    it('should ignore non-relevant entity types (POST)', async () => {
      const event = createMockDynamoDBStreamEvent({
        records: [
          {
            eventName: 'INSERT',
            keys: { PK: 'USER#user-123', SK: 'POST#2024-01-01T00:00:00.000Z#post-123' },
            newImage: {
              PK: 'USER#user-123',
    ...
    it('should continue processing other records on error', async () => {
      ...
      const event = createMockDynamoDBStreamEvent({
        records: [
          {
            eventName: 'INSERT',
            keys: { PK: 'USER#liker-1', SK: 'LIKE#post-1' },
            newImage: {
              PK: 'USER#liker-1',
              SK: 'LIKE#post-1',
              entityType: 'LIKE',
          ...
          {
            eventName: 'INSERT',
            keys: { PK: 'USER#liker-2', SK: 'LIKE#post-2' },
            newImage: {
              PK: 'USER#liker-2',
              SK: 'LIKE#post-2',
              entityType: 'LIKE',
    ...
    it('should process multiple records in parallel', async () => {
      const event = createMockDynamoDBStreamEvent({
        records: [
          ...
          {
            eventName: 'INSERT',
            keys: { PK: 'USER#liker-3', SK: 'LIKE#post-3' },
            newImage: {
              PK: 'USER#liker-3',
              SK: 'LIKE#post-3',
              entityType: 'LIKE',
    ...
    it('should create multiple notifications concurrently', async () => {
      ...
      const event = createMockDynamoDBStreamEvent({
        records: [
          {
            eventName: 'INSERT',
            keys: { PK: 'USER#follower-1', SK: 'FOLLOW#followee-1' },
            newImage: {
              PK: 'USER#follower-1',
          ...
          {
            eventName: 'INSERT',
            keys: { PK: 'USER#follower-2', SK: 'FOLLOW#followee-2' },
            newImage: {
              PK: 'USER#follower-2',
    ...
    it('should handle mixed entity types in single batch', async () => {
      const event = createMockDynamoDBStreamEvent({
        records: [
          ...
          {
            eventName: 'INSERT',
            keys: { PK: 'POST#post-2', SK: 'COMMENT#2024-01-01T00:00:00.000Z#comment-1' },
            newImage: {
              PK: 'POST#post-2',
    ...
    it('should handle invalid entity type', async () => {
      const event = createMockDynamoDBStreamEvent({
        records: [
          {
            eventName: 'INSERT',
            keys: { PK: 'USER#user-123', SK: 'UNKNOWN#123' },
            newImage: {
              PK: 'USER#user-123',
              SK: 'UNKNOWN#123',
