...
export type ExplorePage_exploreFeed$data = {
  ...
  readonly " $fragmentType": "ExplorePage_exploreFeed";
};
export type ExplorePage_exploreFeed$key = {
  readonly " $data"?: ExplorePage_exploreFeed$data;
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": ExplorePageExploreFeedPaginationQuery_graphql
    }
  },
  ...
  "selections": [
    {
      ...
      "kind": "LinkedField",
      "name": "__ExplorePage_exploreFeed_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
